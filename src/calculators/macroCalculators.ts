import { MacroAggregate, TrackerEntry } from "../services/TrackerProcessor";
...
export function calculateMacros(entry: TrackerEntry, recipe: any): { macros: MacroAggregate, originalServingSize?: number, servingSize?: number } | null {
